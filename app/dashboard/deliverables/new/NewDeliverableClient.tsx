...
export default function NewDeliverableClient() {
  ...
  const canGenerate =
    selectedPromptId && deliverableName && selectedPrompt?.variables.every((v) => !v.required || variableValues[v.name]);
          ...
          {selectedPrompt && (
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button className="w-full mt-4" onClick={simulateGeneration} disabled={!canGenerate || isGenerating}>
                  {isGenerating ? (
                    <>
        ...
        <Card className="h-fit">
          ...
          <CardContent>
            <ScrollArea className="h-[600px] w-full rounded-md border">
              <div className="p-4">
                {streamedContent || generatedContent ? (
                  <pre className="whitespace-pre-wrap font-mono text-sm">{streamedContent || generatedContent}</pre>
                ) : (
